    ...
    if (user) {
                    ...
                    then((querySnapshot) => {
                        querySnapshot.forEach((doc) => {
                            if (result.value == doc.data().DatosPersonales.Numero_Identificacion) {
                                ...
                                document.getElementById("dci0").textContent = doc.data().DatosPrescripcionMedicamentosa.DCI_1
                                document.getElementById("concentracion0").textContent = doc.data().DatosPrescripcionMedicamentosa.Concentracion_1
                                document.getElementById("formaFarmaceutica0").textContent = doc.data().DatosPrescripcionMedicamentosa.Forma_Farmaceutica_1
                                document.getElementById("cantidad0").textContent = doc.data().DatosPrescripcionMedicamentosa.Cantidad_1
                                document.getElementById("dci1").textContent = doc.data().DatosPrescripcionMedicamentosa.DCI_2
                                document.getElementById("concentracion1").textContent = doc.data().DatosPrescripcionMedicamentosa.Concentracion_2
                                document.getElementById("formaFarmaceutica1").textContent = doc.data().DatosPrescripcionMedicamentosa.Forma_Farmaceutica_2
                                document.getElementById("cantidad1").textContent = doc.data().DatosPrescripcionMedicamentosa.Cantidad_2
                                document.getElementById("dci2").textContent = doc.data().DatosPrescripcionMedicamentosa.DCI_3
                                document.getElementById("concentracion2").textContent = doc.data().DatosPrescripcionMedicamentosa.Concentracion_3
                                document.getElementById("formaFarmaceutica2").textContent = doc.data().DatosPrescripcionMedicamentosa.Forma_Farmaceutica_3
                                document.getElementById("cantidad2").textContent = doc.data().DatosPrescripcionMedicamentosa.Cantidad_3

                                document.getElementById("dx").value = doc.data().DatosPrescripcionMedicamentosa.Diagnostico_R2
                                document.getElementById("recomendaciones").value = doc.data().DatosRecomendacionUso.Recomendacion
                        ...
                        if (band == false) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = "/views/certificates/prescripcionMedicamentos.html";
                                }
                            });
                        }
                    })
        ...
        imprimir.addEventListener('click', (e) => {
            ...
            html2pdf()
                .set({
                    margin: 0.5,
                    filename: document.getElementById("nombre").value + ' Prescripción de medicamentos',
                    html2canvas: {
